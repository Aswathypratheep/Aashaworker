# Generated by Django 4.1.4 on 2023-03-18 05:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panchayat', models.ForeignKey(max_length=20, on_delete=django.db.models.deletion.CASCADE, to='government.panchayat')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panchayat', models.ForeignKey(max_length=20, on_delete=django.db.models.deletion.CASCADE, to='government.panchayat')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('wid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='government.workers')),
            ],
        ),
        migrations.CreateModel(
            name='Foods',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('district', models.CharField(max_length=20)),
                ('needs', models.CharField(max_length=2000, null=True)),
                ('con', models.CharField(max_length=20, null=True)),
                ('add', models.CharField(max_length=200, null=True)),
                ('date', models.DateField(null=True)),
                ('ward', models.CharField(max_length=100)),
